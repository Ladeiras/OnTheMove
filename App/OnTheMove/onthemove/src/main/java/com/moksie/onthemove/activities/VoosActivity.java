...
public class VoosActivity extends FragmentActivity {
        ...
        searchVoosSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l)
            {
                ...
                if(option == OPTION_SHOW_ALL) {
                    ...
                    AlertDialog.Builder alert = new AlertDialog.Builder(VoosActivity.this);

                    alert.setTitle("Pesquisar por " + options.get(option));
                    //alert.setMessage(options.get(i));

                    // Set an EditText view to get user input
                    final EditText input = new EditText(VoosActivity.this);
                    alert.setView(input);
    ...
    {
        ArrayList<Voo> temp = new ArrayList<Voo>();
    ...
    private void updatePartidas(ArrayList<Voo> voos) {
        VooAdapter partidasAdapter = new VooAdapter(this, android.R.layout.simple_expandable_list_item_1, voos);
        partidasList = (ListView) findViewById(R.id.listView_partidas);
        partidasList.setAdapter(partidasAdapter);
    }

    private void updateChegadas(ArrayList<Voo> voos) {
        VooAdapter chegadasAdapter = new VooAdapter(this, android.R.layout.simple_expandable_list_item_1, voos);
        chegadasList = (ListView) findViewById(R.id.listView_chegadas);

 ...
 */
public class NotificationsBackGroundTask extends AsyncTask<String, String, JSONArray> {
    ...
    public NotificationsBackGroundTask(String url, String method, List<NameValuePair> params) {
        this.URL = url;
